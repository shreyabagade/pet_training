      ...
      <div className="row">
        ...
        <div className="col-md-4 col-12">
          <ul className="info-contact">
            ...
            <li>Email: info@purrfect.com</li>
            <li>Phone: 9018523694</li>
            <li>Address: 25th Road, TPS 3,
        ...
        <div className="col-md-8 col-12">
          ...
          <form className="row form-news">
            ...
            <div className="col-lg-6 col-12 mt-3 mt-lg-0">
              <button type="submit" className="btn-positivus w-100">Subscribe to newsletter</button>
            </div>
          </form>
        ...
        <div className="rights">
          <p>© 2023 Purrfect. All Rights Reserved.</p>
